<?php
    ...
    if(strlen($_POST["kode"])==0) {
        ...
        $user_count = $db->getFieldValue("mapel", array("COUNT(*) AS TOTAL"), array("kode" => $_POST["kode"], "id_kelas" => $_POST["id_kelas"]), array(), 0, 0, "", "id<>'$id'");
    ...
    $db->mysql_update("mapel", $_POST, array("id" => $id));
    $db->mysql_close();
    
    $_SESSION["alert_success"] = "Edit mata pelajaran berhasil.";
