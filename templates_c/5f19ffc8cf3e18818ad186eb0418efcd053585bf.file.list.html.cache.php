<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-08-07 12:46:15
         compiled from "..\..\templates\back-end\AdminLTE-2.3.6\pesertaujian\list.html" */ ?>
<?php /*%%SmartyHeaderCode:561757a6b98a740cb0-01426959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f19ffc8cf3e18818ad186eb0418efcd053585bf' => 
    array (
      0 => '..\\..\\templates\\back-end\\AdminLTE-2.3.6\\pesertaujian\\list.html',
      1 => 1470548770,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '561757a6b98a740cb0-01426959',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a6b98a958135_13393227',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a6b98a958135_13393227')) {function content_57a6b98a958135_13393227($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
">Home</a></li>
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['adminweburl']->value;?>
/pesertauajian/"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</a></li>
...
" class="form-control tanggal" name="tanggal" placeholder="Klik Untuk Memilih Tanggal Ujian..." />
                                                    </div>
...
" class="form-control" name="query" id="query"  placeholder="Masukan kata kunci pencarian..." />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><div id='btn_edit' class="btn btn-success disabled">Edit</div><?php } else { ?><div id='btn_edit' class="btn btn-success disabled">Lihat</div><?php }?>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="15%"><div style="text-align: center;">Tanggal Ujian</div></th>
                                                            <th width="20%"><div style="text-align: center;">Alamat Ujian</div></th>
                                                            <th width="15%"><div style="text-align: center;">Penguji</div></th>
                                                            <th width="10%"><div style="text-align: center;">Jumlah Peserta</div></th>
...
" class="select" /></td>
                                                                ...
                                                                <td align="left"><b><?php echo $_smarty_tpl->tpl_vars['entry']->value['nama_kabupaten'];?>
</b><br /><?php echo $_smarty_tpl->tpl_vars['entry']->value['alamat_cabang'];?>
</td>
                                                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['entry']->value['tanggal_ujian'];?>
</td>
                                                                <td align="left"><?php echo $_smarty_tpl->tpl_vars['entry']->value['alamat_ujian'];?>
</td>
                                                                <td align="left"><?php echo $_smarty_tpl->tpl_vars['entry']->value['nama_penguji'];?>
</td>
                                                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['entry']->value['total'];?>
</td>                                                                
...
" class="btn btn-success edit">Edit</div>
                                                                        <?php } else { ?>
                                                                            <div id_select="<?php echo $_smarty_tpl->tpl_vars['entry']->value['id'];?>
" class="btn btn-success edit">Lihat</div>
                                                                        <?php }?>
