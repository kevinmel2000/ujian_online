<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-01-04 06:28:25
         compiled from "..\templates\back-end\AdminLTE-2.3.6\guru\list.html" */ ?>
<?php /*%%SmartyHeaderCode:32362587b9cfd890592-55906962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3900800498c0d0e5b75fb0dc6d5978318920a283' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\guru\\list.html',
      1 => 1515022101,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32362587b9cfd890592-55906962',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_587b9cfdb20983_95834277',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_587b9cfdb20983_95834277')) {function content_587b9cfdb20983_95834277($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
" class="form-control" name="nama_subjurusan" placeHolder="Ketik untuk memilih subjurusan..."<?php if ($_smarty_tpl->tpl_vars['data_user']->value['id_subjurusan']>0) {?> readonly="readOnly"<?php }?> />
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['data_user']->value['tipe_user']=="S") {?>
                                                <tr>
                                        ...
                                        <?php if (count($_smarty_tpl->tpl_vars['listdetail']->value)>0) {?>
                                            <div id="detail" class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)||in_array('H',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><th width="5px"><div style="text-align: center;"><input type="checkbox" id="select_all" /></div></th><?php }?>
                                                            <th width="5%"><div style="text-align: center;">No.</div></th>
                                                            <th width="25%"><div style="text-align: left;">Sekolah<br />Jurusan / Sub Jurusan</div></th>
                                                            <th width="25%"><div style="text-align: left;">Nama<br />NIK</div></th>
                                                            <th width="10%"><div style="text-align: center;">L/P</div></th>
                                                            <th width="20%"><div style="text-align: left;">Email / No. HP</div></th>
                                                            <th width="10%"><div style="text-align: center;">Jumlah MP</div></th>
                                                            <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><th width="5%"><div style="text-align: center;">Setting</div></th><?php }?>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
...
">
                                                                <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)||in_array('H',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><td align="center"><input type="checkbox" id_select="<?php echo $_smarty_tpl->tpl_vars['entry']->value['id'];?>
...
<br /><small><?php echo $_smarty_tpl->tpl_vars['entry']->value['nik'];?>
</small></td>
                                                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['entry']->value['jenis_kelamin'];?>
</td>
                                                                <td align="left"><?php echo $_smarty_tpl->tpl_vars['entry']->value['email'];
if ($_smarty_tpl->tpl_vars['entry']->value['no_hp']!='') {?><br /><small><?php echo $_smarty_tpl->tpl_vars['entry']->value['no_hp'];?>
</small><?php }?></td> 
                                                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['entry']->value['jumlah_mp'];?>
</td>
...
" class="btn btn-success edit">Setting</div>
                                                                    </div></td>
                                                                <?php }?>
                                                            </tr>
...
if ($_smarty_tpl->tpl_vars['id_sekolah']->value!='') {?>&id_sekolah=<?php echo $_smarty_tpl->tpl_vars['id_sekolah']->value;
}?>">&larr; Prev</a>
                                                    <?php }?>
...
/store/kelasDataStore.php',
            ...
            $( "#btn_cari" ).click(function() {
                ...
                window.location='list.php?'+(query.length>0?'&query='+query:'')+(sekolah.length>0?'&id_sekolah='+sekolah:'')+(jurusan.length>0?'&id_jurusan='+jurusan:'')+(subjurusan.length>0?'&id_subjurusan='+subjurusan:'')<?php if ($_smarty_tpl->tpl_vars['data_user']->value['tipe_user']=="S") {?>+(kelas.length>0?'&id_kelas='+kelas:'')<?php }?>;
            });
...
if ($_smarty_tpl->tpl_vars['sekolah']->value!='') {?>&sekolah=<?php echo $_smarty_tpl->tpl_vars['sekolah']->value;
}
if ($_smarty_tpl->tpl_vars['tingkat']->value!='') {?>&tingkat=<?php echo $_smarty_tpl->tpl_vars['tingkat']->value;
}
if ($_smarty_tpl->tpl_vars['kelas']->value!='') {?>&kelas=<?php echo $_smarty_tpl->tpl_vars['kelas']->value;
}?>';
                                    } else {
                                        $('#detail').unmask();
