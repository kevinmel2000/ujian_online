<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-08-07 14:55:31
         compiled from "..\..\templates\back-end\AdminLTE-2.3.6\pesertaujian\edit.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a6a9756f5452_84166771',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a6a9756f5452_84166771')) {function content_57a6a9756f5452_84166771($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="col-md-3 no-padding">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['entry']->value['geup'];?>
" name="geup" placeholder="No. Geup" />
                                                                <span class="input-group-btn">
                                                                    <div id="i_loading" style="padding: 0 10px 0 10px; display: none;"><img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><th width="5%"><div style="text-align: center;">Update</div></th><?php }?>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
...
" class="select" /></td>
 ...
 / <?php echo $_smarty_tpl->tpl_vars['entry']->value['tanggal_lahir'];?>
                                                                ...
                                                                <td align="center"><?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)) {?><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['entry']->value['geup'];?>
" class="form-control text-center geup" name="geup" /><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['entry']->value['id'];?>
" name="id_peserta" /><?php } else {
echo $_smarty_tpl->tpl_vars['entry']->value['geup'];
}?></td>                                                                
                                                                
                                                                <?php if (in_array('E',$_smarty_tpl->tpl_vars['array_akses']->value)) {?>
                                                                <td><div style="text-align: center;  white-space: nowrap;">
                                                                            <div class="i_loading_update" style="display: none;"><img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/dist/img/loading.gif" /></div>
...
':'');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data['success']) {
                            window.location = 'edit.php?id='+$('[name=id_ujian]').val()+'<?php if ($_smarty_tpl->tpl_vars['currentpage']->value>0) {?>&page=<?php echo $_smarty_tpl->tpl_vars['currentpage']->value;
}
if ($_smarty_tpl->tpl_vars['query']->value!='') {?>&query=<?php echo $_smarty_tpl->tpl_vars['query']->value;
}?>';                    
                        } else {
