<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-01-03 17:36:53
         compiled from "..\templates\back-end\AdminLTE-2.3.6\siswa\edit.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_587b9395239566_36446797',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_587b9395239566_36446797')) {function content_587b9395239566_36446797($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
echo $_smarty_tpl->tpl_vars['data']->value[0]['nama_kelas'];
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="<?php if ($_smarty_tpl->tpl_vars['isEdit']->value==true) {
echo $_smarty_tpl->tpl_vars['data']->value[0]['id_subkelas'];
}?>" name="id_subkelas" />
                                            <input type="text" value="<?php if ($_smarty_tpl->tpl_vars['isEdit']->value==true) {
echo $_smarty_tpl->tpl_vars['data']->value[0]['nama_subkelas'];
}?>" class="form-control" name="nama_subkelas" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nim">NIM:</label>
                                            <input type="text" value="<?php if ($_smarty_tpl->tpl_vars['isEdit']->value==true) {
echo $_smarty_tpl->tpl_vars['data']->value[0]['nim'];
