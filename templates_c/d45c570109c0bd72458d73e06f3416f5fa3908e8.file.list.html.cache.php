<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-06-27 08:46:37
         compiled from "..\..\templates\back-end\matrix\konfirmasi_pembayaran\list.html" */ ?>
<?php /*%%SmartyHeaderCode:8010577081b9e6c823-59597841%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd45c570109c0bd72458d73e06f3416f5fa3908e8' => 
    array (
  ...
  'nocache_hash' => '8010577081b9e6c823-59597841',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_577081ba0c1bf2_19890895',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_577081ba0c1bf2_19890895')) {function content_577081ba0c1bf2_19890895($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
' style="font-weight: bold; color: <?php if ($_smarty_tpl->tpl_vars['entry']->value['status_confirm']==1) {?>red<?php } elseif ($_smarty_tpl->tpl_vars['entry']->value['status_confirm']==2) {?>green<?php } else { ?>orange<?php }?>;"><?php if ($_smarty_tpl->tpl_vars['entry']->value['status_confirm']==1) {?>Tidak Valid<?php } elseif ($_smarty_tpl->tpl_vars['entry']->value['status_confirm']==2) {?>Valid<?php } else { ?>Menunggu<?php }?></span></td></tr>
                                                    <tr><td colspan="2"><div style="margin-top: 10px;">
                                                        <?php if ($_smarty_tpl->tpl_vars['entry']->value['status_confirm']==0) {?>
...
/assets/img/loading.gif" /></div>                                                
                                                        <div name="btn_valid_<?php echo $_smarty_tpl->tpl_vars['entry']->value['id'];?>
...
" id="<?php echo $_smarty_tpl->tpl_vars['entry']->value['id'];?>
" type="submit" class="btn btn-warning invalid">INVALID</div>
 ...
 type="text/javascript">
        $(function () {
            ...
            $( "#btn_cari" ).click(function() {
                var query = $( "#query" ).val();
                var filter = $('#filter_status').val();
                window.location='list.php?_'+(filter.length>0?'&status='+filter:'')+(query.length>0?'&query='+query:'');
            });
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if(data['success']) {
                                        ...
                                        $('#i_loading_'+id).hide();
                                        $('[name=btn_valid_'+id+']').hide();
                                        $('[name=btn_invalid_'+id+']').hide();
