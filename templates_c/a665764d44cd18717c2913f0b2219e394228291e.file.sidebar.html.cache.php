<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-01 15:34:49
         compiled from "D:\www\gomochart\templates\front-end\boxed\includes\sidebar.html" */ ?>
<?php /*%%SmartyHeaderCode:2485357762b295d2cc8-02550163%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a665764d44cd18717c2913f0b2219e394228291e' => 
    array (
      0 => 'D:\\www\\gomochart\\templates\\front-end\\boxed\\includes\\sidebar.html',
      1 => 1467362070,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2485357762b295d2cc8-02550163',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57762b296507a7_64173511',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57762b296507a7_64173511')) {function content_57762b296507a7_64173511($_smarty_tpl) {?><div class="col-sm-3 col-left">
    <!-- div class="timely">
...
/assets/images/products/15.jpg" alt="Primis in faucibus" />
                            </a>
                        </div>
                    ...
                    <div class="item-inner">
                        <div class="images-container">
                            <a href="#" title="Accumsan elit " class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/14.jpg" alt="Accumsan elit " />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner">
                        <div class="images-container">
                            <a href="#" title="Nunc facilisis" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/5.jpg" alt="Nunc facilisis" />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner last">
                        <div class="images-container">
                            <a href="#" title="Fusce aliquam" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/8.jpg" alt="Fusce aliquam" />
                            </a>
                        </div>
                        <div class="des-container">
                            <h2 class="product-name"><a href="#" title="Fusce aliquam">Fusce aliquam</a></h2>
                    ...
                    <div class="item-inner first">
                        <div class="images-container">
                            <a href="h#" title="consequences" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/9.jpg" alt="consequences" />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner">
                        <div class="images-container">
                            <a href="#" title="Cras neque metus" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/12.jpg" alt="Cras neque metus" />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner ">
                        <div class="images-container">
                            ...
                            <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/4.jpg" alt="Etiam gravida" />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner last">
                        <div class="images-container">
                            ...
                            <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/9.jpg" alt="Donec non est" />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner first">
                        <div class="images-container">
                            <a href="#" title="pleasure rationally" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/10.jpg" alt="pleasure rationally" />
                            </a>
                        </div>
                        <div class="des-container">
                            <h2 class="product-name"><a href="#" title="pleasure rationally">pleasure rationally</a></h2>
                    ...
                    <div class="item-inner ">
                        <div class="images-container">
                            <a href="#" title="Aliquam consequat" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/5.jpg" alt="Aliquam consequat" />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner ">
                        <div class="images-container">
                            <a href="#" title=" Donec ac tempus " class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/11.jpg" alt=" Donec ac tempus " />
                            </a>
                        </div>
                        <div class="des-container">
                    ...
                    <div class="item-inner last">
                        <div class="images-container">
                            <a href="#" title="occaecati cupiditate" class="product-image">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/products/6.jpg" alt="occaecati cupiditate" />
                            </a>
                        </div>
                        <div class="des-container">
...
/assets/images/blog/blog-01.jpg" /> </a>
                        </div>
                        <div class="des-container">
                ...
                <div>
                    <div class="item-inner">
                        <div class="images-container">
                            <a href="#"> <img alt="" src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/blog/blog-02.jpg" /> </a>
                        </div>
                        <div class="des-container">
                            <div class="date-comments">
                    ...
                    <div class="testimonial-sidebar-content">
                        ...
                        <div class="post-by">
                            <div class="testimonial-content-avatar">
                                <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/avatar/avatar-01.jpg" alt="test" />
                            </div>
                ...
                <div class='testimonial-list'>
                    <div class="testimonial-sidebar-content">
                        ...
                        <div class="post-by">
                            <div class="testimonial-content-avatar">
                                <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/avatar/avatar-02.jpg" alt="test" />
                            </div>
                            <div class="box-author">
                ...
                <div class='testimonial-list'>
                    <div class="testimonial-sidebar-content">
                        ...
                        <div class="post-by">
                            <div class="testimonial-content-avatar">
                                <img src="<?php echo $_smarty_tpl->tpl_vars['tpl_dir']->value;?>
/assets/images/avatar/avatar-03.jpg" alt="test" />
                            </div>
                            <div class="box-author">
