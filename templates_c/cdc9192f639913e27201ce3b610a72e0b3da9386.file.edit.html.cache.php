<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-09-16 08:56:05
         compiled from "..\templates\back-end\AdminLTE-2.3.6\grupsoal\edit.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57db4c5f8e1104_12588913',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57db4c5f8e1104_12588913')) {function content_57db4c5f8e1104_12588913($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
">Home</a></li>
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['adminweburl']->value;?>
/grupsoal/"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</a></li>
...
echo $_smarty_tpl->tpl_vars['data']->value[0]['mapel'];
} else {
echo $_smarty_tpl->tpl_vars['data_user']->value['nama_mapel'];
}?>" class="form-control" <?php if ($_smarty_tpl->tpl_vars['data_user']->value['tipe_user']=='U') {?>disabled<?php }?> name="mapel" />
                                            <input type="hidden" value="<?php if ($_smarty_tpl->tpl_vars['isEdit']->value==true) {
echo $_smarty_tpl->tpl_vars['data']->value[0]['id_mapel'];
} else {
echo $_smarty_tpl->tpl_vars['data_user']->value['id_mapel'];
}?>" name="id_mapel" />
                                        </div>
...
" class="form-control tanggal" name="kode_soal" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="keterangan">Keterangan:</label>
                                            <textarea class="form-control" name="keterangan" style="height: 100px;"><?php echo $_smarty_tpl->tpl_vars['data']->value[0]['keterangan'];?>
</textarea>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nilai_benar">Nilai Benar:</label>
                                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[0]['nilai_benar'];?>
" class="form-control" name="nilai_benar" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nilai_salah">Nilai Salah:</label>
                                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[0]['nilai_salah'];?>
" class="form-control" name="nilai_salah" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="perhitungan_score">Perhitungan Score:</label>
                                            <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[0]['perhitungan_score'];?>
