<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-08-25 13:43:57
         compiled from "..\templates\back-end\AdminLTE-2.3.6\pesanmasuk\detail.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57be930f381422_20170873',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57be930f381422_20170873')) {function content_57be930f381422_20170873($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label  class="form-control" style="font-weight: normal;"><?php echo $_smarty_tpl->tpl_vars['data']->value[0]['tanggal'];?>
</label>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="username">Pengguna:</label>
                                            <label  class="form-control" style="font-weight: normal;"><?php echo $_smarty_tpl->tpl_vars['data']->value[0]['username'];?>
</label>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama_bkd">BKD:</label>
                                            <label  class="form-control" style="font-weight: normal;"><?php echo $_smarty_tpl->tpl_vars['data']->value[0]['nama_bkd'];?>
</label>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="pesanmasuk">pesanmasuk:</label>
                                            <label id="pesanmasuk" class="form-control" style="font-weight: normal; height:100px;"><?php echo $_smarty_tpl->tpl_vars['data']->value[0]['pesanmasuk'];?>
</label>
                                        </div>
