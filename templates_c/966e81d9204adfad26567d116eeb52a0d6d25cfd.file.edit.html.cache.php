<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-08-04 15:23:39
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5782dd094d2ca8_04822428',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_5782dd094d2ca8_04822428')) {function content_5782dd094d2ca8_04822428($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
" name="harga" class="form-control harga" placeholder="" /></td>' +
                        '<td style="padding: 5px;"><div style="text-align: center;  white-space: nowrap;"><?php if ($_smarty_tpl->tpl_vars['no']->value>1) {?><div class="btn btn-danger hapus_grosir">Hapus</div><?php }?></div></td>' +
                        '<td style="padding: 5px;"><div style="text-align: center;  white-space: nowrap;"><?php if ($_smarty_tpl->tpl_vars['no']->value==1) {?><div id="btn_tambah_grosir" class="btn btn-primary">Tambah</div><?php }?></div></td>' +
                    '</tr>';
