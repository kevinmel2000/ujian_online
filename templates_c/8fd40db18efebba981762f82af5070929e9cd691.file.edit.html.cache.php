<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-02-20 13:42:09
         compiled from "..\templates\back-end\AdminLTE-2.3.6\essai\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:271705880df74625625-91832770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8fd40db18efebba981762f82af5070929e9cd691' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\essai\\edit.html',
      1 => 1485297472,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '271705880df74625625-91832770',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5880df7471f877_74923914',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_5880df7471f877_74923914')) {function content_5880df7471f877_74923914($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['include_tpl']->value)."/includes/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <td><label for="jawaban_essai">Kunci Jawaban:</label></td>
                                                    <td><div class="summernote_kunci_jawaban"></div></td>                                                    
                                                </tr>                                                
                                            </table>
                                        </div>
...
>
 ...
 type="text/javascript">
        $(function () {           
            ...
            $('.summernote_kunci_jawaban').summernote({
                height: 100,
                toolbar: [
                    ['style', ['style']],
                    ['font', ['bold', 'italic', 'underline', 'clear']],
...
echo $_smarty_tpl->tpl_vars['data']->value[0]['pertanyaan'];
            ...
            $(".summernote_kunci_jawaban").code('<?php if ($_smarty_tpl->tpl_vars['isEdit']->value==true) {
echo $_smarty_tpl->tpl_vars['data']->value[0]['jawaban_essai'];
}?>');
...
');
                ...
                data.append('jawaban_essai', $('.summernote_kunci_jawaban').summernote().code().replace(/\n/, '<br />'));
