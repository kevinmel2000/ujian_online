<?php
    ...
    $data[0]["jawaban_essai"] = preg_replace("/\r\n|\r|\n/",'<br/>',$data[0]["jawaban_essai"]);
    ...
    $smarty->assign("sub_title", "Ubah Data Soal Essai");
    
    $id_menu = 7; $aksi = "E";
    include $root."includes/php/notification.php";
    
    $db->mysql_close();
    $smarty->display(BACK_END_TEMPLATE_PATH."/essai/edit.html");    