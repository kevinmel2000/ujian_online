<?php
    ...
    $totalrecord = $db->getFieldValue(
        ...
        (strlen($query)>0?" AND A.kode_soal LIKE '%$query%' OR A.nama_soal LIKE '%$query%' OR A.keterangan LIKE '%$query%' OR B.nama LIKE '%$query%' OR B.nama_sekolah LIKE '%$query%' OR B.nama_jurusan LIKE '%$query%' OR B.nama_subjurusan LIKE '%$query%' OR B.nama_kelas LIKE '%$query%'":"")
    );
    ...
    $db->mysql_close();
    $smarty->display(BACK_END_TEMPLATE_PATH."/ujian/list.html");    