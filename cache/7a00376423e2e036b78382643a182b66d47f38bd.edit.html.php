<?php /*%%SmartyHeaderCode:2601857be96429ee4e1-58317101%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a00376423e2e036b78382643a182b66d47f38bd' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\pesanmasuk\\edit.html',
      1 => 1472107991,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2601857be96429ee4e1-58317101',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57be965c61cae8_44943817',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57be965c61cae8_44943817')) {function content_57be965c61cae8_44943817($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Kirim Pesan | Kirim Pesan Baru</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Kirim Pesan <small>Kirim Pesan Baru</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.101/pelaporan_pelanggaran">Home</a></li>
                    <li><a href="http://192.168.1.101/pelaporan_pelanggaran/kirimpesan/add.php">Kirim Pesan</a></li>
                    <li class="active">Kirim Pesan Baru</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="pesanmasuk">Isi Pesan:</label>
                                            <textarea class="form-control" name="pesan" style="height: 100px;" placeholder="Isi Pesan"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a id="btn_batal"  href="add.php" class="btn btn-warning">Batal</a>                                            
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
    ...
    <script type="text/javascript">
        $(function () {  
            ...
            $('#btn_simpan').click(function() {
                ...
                data.append('pesanmasuk', $('[name=pesan]').val());
            ...
            setMessage('success', 'Kirim pesan berhasil.');        });
    </script>
</body>
