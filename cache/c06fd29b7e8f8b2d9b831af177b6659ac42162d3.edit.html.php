...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a686b3705739_42958289',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a686b3705739_42958289')) {function content_57a686b3705739_42958289($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Cabang | Add new Cabang</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="http://192.168.1.100/sertifikat_online/taekwondo/">Cabang</a></li>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="no_reg" />
                                        </div>
        ...
        $(function () {           
            ...
            $('[name=nama_kabupaten]').autocomplete({
                source: function( request, response ) {
                    $.ajax({
                        url: 'http://192.168.1.100/sertifikat_online/store/kabupatenDataStore.php',
                        dataType: "json",
                        method: 'post',
                        data: {
                            query: request.term
