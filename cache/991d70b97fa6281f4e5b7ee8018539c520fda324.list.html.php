...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a053d50c1778_86692722',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a053d50c1778_86692722')) {function content_57a053d50c1778_86692722($_smarty_tpl) {?><!DOCTYPE html>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td width="5px">&nbsp;</td>
                                    <td width="100%"><input type="text" value="agra" class="form-control" name="query" id="query" placeholder="Masukan kata kunci pencarian..." /></td>
                                    <td width="5px">&nbsp;</td> 
                        ...
                        Yes: function () {
                            ...
                            $.ajax({
                                ...
                                success: function(data, textStatus, jqXHR) {
                                    if(data['success']) {
                                        window.location='list.php?query=agra';
                                    } else {
                                        $('#detail').unmask();
