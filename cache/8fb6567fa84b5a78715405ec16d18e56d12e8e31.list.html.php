...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4cadf27f0927_62128112',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4cadf27f0927_62128112')) {function content_5a4cadf27f0927_62128112($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Sub Kelas | Daftar Sub Kelas</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Sub Kelas <small>Daftar Sub Kelas</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/kelas/">Kelas</a></li>
                    <li><a href="http://localhost/ujian_online/subkelas/">Sub Kelas</a></li>
                    <li class="active">Daftar Sub Kelas</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" value="Satu" class="form-control" name="nama_kelas" readonly="readOnly" />
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="form-group">
                                            <div id='btn_add' class="btn btn-primary">Baru</div>                                            <div id='btn_edit' class="btn btn-success disabled">Edit</div>                                            <div id='btn_delete' class="btn btn-danger disabled">Hapus</div>                                        
                                            <a href="http://localhost/ujian_online/kelas" class="btn btn-primary pull-right">Kembali ke Kelas</a>
                                        </div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="center">XSa1121</td>
                                                                <td align="left">Kelas Sati ssr AS11</td>                                                  
                                                            </tr>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#btn_add" ).click(function() {
                window.location='add.php?id_kelas=1';
            });
            ...
            $( "#btn_cari" ).click(function() {
                var query = $( "#query" ).val();
                window.location='list.php?id_kelas=1&'+(query.length>0?'&query='+query:'');
            });
                        ...
                        Yes: function () {
                            ...
                            $.ajax({
                                ...
                                success: function(data, textStatus, jqXHR) {
                                    if(data['success']) {
                                        window.location='list.php?id_kelas=1';
                                    } else {
                                        $('#detail').unmask();
