...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a058d197cf29_35778959',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a058d197cf29_35778959')) {function content_57a058d197cf29_35778959($_smarty_tpl) {?><!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- ol class="breadcrumb">
                          ...
                          <li><a href="http://192.168.1.101/gomocart/category">Category</a></li>
                ...
                <div class="row">                    
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="Agraris" class="form-control" name="nama" placeholder="" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_parent">
                            <option value="0"  selected="selected" >Tidak Ada</option>
                                                        <option value="1" >Agraris</option>                                        
                                                        <option value="2" >Pakaian</option>                                        
                                                        <option value="3" >Mobil & Sepeda Motor</option>                                        
                                                        <option value="4" >Kecantikan & Perawatan Diri</option>                                        
                                                        <option value="5" >Layanan Bisnis</option>                                        
                                                        <option value="6" >Bahan Kimia</option>                                        
                                                        <option value="7" >Komputer & Software</option>                                        
                                                        <option value="8" >Konstruksi & Properti</option>                                        
                                                        <option value="9" >Electronik Konsumen</option>                                        
                                                        <option value="10" >Elektronik & Elektrik</option>                                        
                                                        <option value="11" >Energi</option>                                        
                                                        <option value="12" >Lingkungan Hidup</option>                                        
                                                        <option value="13" >Fashion Aksesoris</option>                                        
                                                        <option value="14" >Makanan & Minuman</option>                                        
                                                        <option value="15" >Mebel</option>                                        
                                                        <option value="16" >Peralatan Industri Umun</option>                                        
                                                        <option value="17" >Peralatan Mekanik & Suku Cadang</option>                                        
                                                        <option value="18" >Hadiah & Kerajinan</option>                                        
                                                        <option value="19" >Kesehatan & Pengobatan</option>                                        
                                                        <option value="20" >Rumah & Taman</option>                                        
                                                        <option value="21" >Peralatan Rumah Tangga</option>                                        
                                                        <option value="22" >Lampu & Pencahayaan</option>                                        
                                                        <option value="23" >Bagasi, Tas & Dompet</option>                                        
                                                        <option value="24" >Mesin & Alat Berat</option>                                        
                                                        <option value="25" >Peralatan Pengukuran & Analisis</option>                                        
                                                        <option value="26" >Mineral & Metal</option>                                        
                                                        <option value="27" >Perlengkapan Kantor & Sekolah</option>                                        
                                                        <option value="28" >Pembungkus & Kertas</option>                                        
                                                        <option value="29" >Percetakan & Penerbitan</option>                                        
                                                        <option value="30" >Karet & Plastik</option>                                        
                                                        <option value="31" >Keamanan & Perlindungan</option>                                        
                                                        <option value="32" >Peralatan Jasa</option>                                        
                                                        <option value="33" >Sepatu & Aksesoris</option>                                        
                                                        <option value="34" >Olahraga & Hiburan</option>                                        
                                                        <option value="35" >Telekomunikasi</option>                                        
                                                        <option value="36" >Tekstil & Kulit</option>                                        
                                                        <option value="37" >Permata, Jam Tangan & Kacamata</option>                                        
                                                        <option value="38" >Mainan</option>                                        
                                                        <option value="39" >Transportasi</option>                                        
                                                    </select>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {           
            ...
            $('.image-editor').cropit({
              smallImage: 'stretch',
              imageState: {
                src: 'http://192.168.1.101/gomocart/uploads/category/agraris_4328.png',
              }            });
