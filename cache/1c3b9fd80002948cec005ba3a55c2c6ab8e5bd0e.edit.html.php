<?php /*%%SmartyHeaderCode:2214557ccbc4a518976-27398865%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c3b9fd80002948cec005ba3a55c2c6ab8e5bd0e' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\peserta\\edit.html',
      1 => 1473035719,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2214557ccbc4a518976-27398865',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57ccbe589039e5_63112718',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ccbe589039e5_63112718')) {function content_57ccbe589039e5_63112718($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>peserta | Tambah Data Peserta</title>
...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <ul class="sidebar-menu">
        <li class="header"> MENU </li>
                ...
                <a href="http://192.168.1.101/ujian_online/pengguna/"><i class="fa fa-user"></i> <span>Pengaturan Pengguna</span> </a>
                    ...
                    <li class="treeview">
                <a href="http://192.168.1.101/ujian_online/pengumuman/"><i class="fa fa-bars"></i> <span>Pengumuman</span> </a>
                            </li>
                    <li class="treeview">
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    peserta <small>Tambah Data Peserta</small>
                </h1>
                <ol class="breadcrumb">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="id_peserta"  />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama_peserta">Nama Peserta:</label>
                                            <input type="text" value="" class="form-control" name="nama_peserta" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="asal_sekolah" />
                                        </div>

                                        <div class="form-group">
                                            <label for="jurusan">Jurusan:</label>
                                            <input type="text" value="" class="form-control" name="jurusan" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="tahun_lulus">Tahun Lulus:</label>
                                            <input type="text" value="" class="form-control" name="tahun_lulus" />
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control tanggal" name="tanggal_lahir" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <div id="i_loading" class="G-btn-animation" style="display: none;"><img src="http://192.168.1.101/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/img/loading.gif" /></div>                  
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <link rel="stylesheet" href="http://192.168.1.101/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/js/jquery-ui/jquery-ui-1.10.3.custom.min.css">
    ...
    <script type="text/javascript">
        $(function () {           
            ...
            $('#btn_simpan').click(function() {
                ...
                data.append('id_peserta', $('[name=id_peserta]').val());
                data.append('nama_peserta', $('[name=nama_peserta]').val());
                data.append('alamat', $('[name=alamat]').val());
                data.append('telepon', $('[name=telepon]').val());
                data.append('asal_sekolah', $('[name=asal_sekolah]').val());
                data.append('jurusan', $('[name=jurusan]').val());
                data.append('tahun_lulus', $('[name=tahun_lulus]').val());
                data.append('tempat_lahir', $('[name=tempat_lahir]').val());
                var temp = $('[name=tanggal_lahir]').val().split('-');
                data.append('tgl_lahir', temp[2]+"-"+temp[1]+"-"+temp[0]);
