<?php /*%%SmartyHeaderCode:2349357a3d582458173-89224829%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '721dd5866bbb10e36c4e2c7309ae8d4711ed06f2' => 
    array (
    ...
    '8d3f27283b3c2059d754d630429a5bed556ac930' => 
    array (
      0 => 'D:\\www\\sertifikat_online\\templates\\back-end\\AdminLTE-2.3.6\\includes\\footer_js.html',
      1 => 1470355804,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2349357a3d582458173-89224829',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a6c8f5ee6b16_79483472',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a6c8f5ee6b16_79483472')) {function content_57a6c8f5ee6b16_79483472($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <ul class="sidebar-menu">
        <li class="header"> MENU </li>
                ...
                <a href="http://192.168.1.100/sertifikat_online/adminweb/noregistrasi/"><i class="fa fa-bookmark"></i> <span>Nomer Registrasi</span> </a>
                    ...
                    <li class="treeview">
                <a href="http://192.168.1.100/sertifikat_online/adminweb/pesertaujian/"><i class="fa fa-user"></i> <span>Peserta Ujian</span> </a>
                            </li>
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user1-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user3-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user1-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user7-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user3-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user5-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user6-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user8-128x128.jpg" alt="User Image">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user1-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Alexander Pierce</a>
                      <span class="users-list-date">Today</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user8-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Norman</a>
                      <span class="users-list-date">Yesterday</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user7-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Jane</a>
                      <span class="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user6-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">John</a>
                      <span class="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user2-160x160.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Alexander</a>
                      <span class="users-list-date">13 Jan</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user5-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Sarah</a>
                      <span class="users-list-date">14 Jan</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user4-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Nora</a>
                      <span class="users-list-date">15 Jan</span>
                    </li>
                    <li>
                      <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/user3-128x128.jpg" alt="User Image">
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/default-50x50.gif" alt="Product Image">
                  </div>
