<?php /*%%SmartyHeaderCode:16246587ffe51543e96-53332050%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b1c8a1bcff3153c92bcce8b2d66ea8de10b581e' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\essai\\list.html',
      1 => 1515123909,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16246587ffe51543e96-53332050',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a4ef53e99bdb4_27918057',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4ef53e99bdb4_27918057')) {function content_5a4ef53e99bdb4_27918057($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Ujian | Daftar Soal Essai</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Ujian <small>Daftar Soal Essai</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/essai/list.php?id=2">Ujian</a></li>
                    <li class="active">Daftar Soal Essai</li>
                </ol>
            </section>
                                    ...
                                    <div class="col-md-12">
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Ujian Kenaikan Kelas Bahasa Inggris</td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <ul id="myTab" class="nav nav-tabs">                                
                                                <li>
                                                    <a href="http://localhost/ujian_online/pilihanganda/list.php?id=2"><b>Pilihan Ganda</b></a>
                                                </li>                                 
                                                <li class="active">
                                                    <a href="#"><b>Essai</b></a>
                                                </li>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <tr id="baris_51">
                                                                        ...
                                                                        <td align="left">Siapa Nama KAmu.<br></td> 
                                                                        <td align="left">AAA<br></td>
                                                                        <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                            <div id_select="51" class="btn btn-success edit">Edit</div>                                                                            <div id_select="51" class="btn btn-danger hapus">Hapus</div>                                                                        </div></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr id="baris_52">
                                                                        ...
                                                                        <td align="left">AAA 123<br></td>
                                                                        <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                            <div id_select="52" class="btn btn-success edit">Edit</div>                                                                            <div id_select="52" class="btn btn-danger hapus">Hapus</div>                                                                        </div></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr id="baris_57">
                                                                        ...
                                                                        <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                            <div id_select="57" class="btn btn-success edit">Edit</div>                                                                            <div id_select="57" class="btn btn-danger hapus">Hapus</div>                                                                        </div></td>
                                                                    </tr>
    ...
    <script type="text/javascript">
        $(function () {
            $( "#btn_add" ).click(function() {
                window.location='add.php?id_head=2';
            });
            ...
            $( ".edit" ).click(function() {
                var id = this.getAttribute('id_select');
                window.location='edit.php?id_head=2&id='+id;
            });
            ...
            setMessage('success', 'Tambah soal essai berhasil.');        
