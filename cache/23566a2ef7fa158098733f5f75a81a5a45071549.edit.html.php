...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a531e3d3c1583_02178905',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a531e3d3c1583_02178905')) {function content_5a531e3d3c1583_02178905($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Ujian | Ubah Data Ujian</title>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="Biologi" class="form-control" name="nama_pelajaran" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="tanggal_ujian">Tanggal Ujian:</label>
                                            <input type="text" value="08-01-2018" class="form-control tanggal" name="tanggal_ujian" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="jam_ujian">Jam Ujian:</label>
                                            <input type="text" value="09:30" class="form-control timepicker" name="jam_ujian" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kode_soal">Kode Soal:</label>
                                            <input type="text" value="AAGYM" class="form-control" name="kode_soal" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama_soal">Nama Soal:</label>
                                            <input type="text" value="Tes Ujian Biologi" class="form-control" name="nama_soal" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="({benar}-{salah})*100" class="form-control" name="perhitungan_score" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="190" class="form-control" name="lama_waktu_pengerjaan" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="publish_score"  />
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <script type="text/javascript">
        $(function () {           
            ...
            $(".summernote").code('Ini adalah Tes Ujian Saua<br>');
