<?php /*%%SmartyHeaderCode:960157be930f2e7971-15291770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b9534e343193d0ba7f6d68d9688627a669a467c1' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\pesanmasuk\\detail.html',
      1 => 1472107435,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '960157be930f2e7971-15291770',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57be93cacfd5e2_54518486',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57be93cacfd5e2_54518486')) {function content_57be93cacfd5e2_54518486($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>pesanmasuk | Edit pesanmasuk</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    pesanmasuk <small>Edit pesanmasuk</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.101/pelaporan_pelanggaran">Home</a></li>
                    <li><a href="http://192.168.1.101/pelaporan_pelanggaran/pesanmasuk/">pesanmasuk</a></li>
                    <li class="active">Edit pesanmasuk</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label  class="form-control" style="font-weight: normal;">25-08-2016</label>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="username">Pengguna:</label>
                                            <label  class="form-control" style="font-weight: normal;">tesuser</label>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama_bkd">BKD:</label>
                                            <label  class="form-control" style="font-weight: normal;">Propinsi Jawa Barat</label>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="pesanmasuk">pesanmasuk:</label>
                                            <label id="pesanmasuk" class="form-control" style="font-weight: normal; height:100px;">Urgent Cepat Tangkap</label>
                                        </div>
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <script type="text/javascript">
        $(function () {           
            $('#detail').height($('#detail').scrollHeight);
