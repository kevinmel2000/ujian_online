...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4f4b020c9592_08857606',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4f4b020c9592_08857606')) {function content_5a4f4b020c9592_08857606($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Koreksi | Koreksi Jawaban Siswa</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Koreksi <small>Koreksi Jawaban Siswa</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/koreksi_siswa/list.php?id=4">Koreksi</a></li>
                    <li class="active">Koreksi Jawaban Siswa</li>
                </ol>
            </section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="tab-pane fade active in" id="pilihanganda">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%" align="center"><input type="checkbox" id_soal="36" name="koreksi_pilihanganda_1" checked /></td>
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%" align="center"><input type="checkbox" id_soal="37" name="koreksi_pilihanganda_2"  /></td>
                                            ...
                                            <div class="tab-pane fade" id="essai">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%" align="center"><input type="checkbox" id_soal="38" name="koreksi_essai_1" checked /></td>
                                                                        <td width="5%" align="center">1</td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a id="btn_batal"  href="list.php?id=4" class="btn btn-warning">Batal</a>                                            
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
