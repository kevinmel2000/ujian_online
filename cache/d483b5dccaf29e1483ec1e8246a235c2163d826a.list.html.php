<?php /*%%SmartyHeaderCode:107445781c8471fb787-13085465%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd483b5dccaf29e1483ec1e8246a235c2163d826a' => 
    array (
      0 => '..\\..\\templates\\back-end\\matrix\\banner\\list.html',
      1 => 1469843739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '107445781c8471fb787-13085465',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_579ffb7268bed1_07482990',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_579ffb7268bed1_07482990')) {function content_579ffb7268bed1_07482990($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Banner <small>List of Banner</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/banner">Banner</a></li>
                          <li class="active">List of Banner</li>
                        </ol -->
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%"><div style="text-align: center;">Nama</div></th>
                                        <th width="30%"><div style="text-align: center;">Konten</div></th>
                                        <th width="20%"><div style="text-align: center;">Banner</div></th>
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_4">
                                            ...
                                            <td align="left">Our new range of<br />Women<br /><br />For less than $199.00</td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/banner/slide-04.jpg" width="190px" />
                                            </div></td>
                                        ...
                                        <tr id="baris_3">
                                            ...
                                            <td align="left">shopping bags<br />fashion collection 2015<br />sale up to!<br />30% off</td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/banner/slide-03.jpg" width="190px" />
                                            </div></td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                                            </div></td>
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td align="left">Samsung s5<br />Typi non habent claritatem insitam; est usus legentis<br />sale up to!<br />50% off</td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/banner/slide-02.jpg" width="190px" />
                                            </div></td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/banner/img-05.png" width="95px" />                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                        ...
                                        <tr id="baris_1">
                                            ...
                                            <td align="left">Headphones AZ12<br />Typi non habent claritatem insitam; est usus legentis<br />sale up to!<br />30% off</td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/banner/slide-01.jpg" width="190px" />
                                            </div></td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/banner/img-04.png" width="95px" />                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
