...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a6e84384ddc8_68952142',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a6e84384ddc8_68952142')) {function content_57a6e84384ddc8_68952142($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Pengajuan Sertifikat | List of Pengajuan Sertifikat</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Pengajuan Sertifikat <small>List of Pengajuan Sertifikat</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">List of Pengajuan Sertifikat</li>
                </ol>
            </section>
                            ...
                            <div class="box-body">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-4 no-padding">
                                                        <input type="text" value="01-08-2016" class="form-control tanggal" name="tanggal" placeholder="Klik Untuk Pilih Tanggal Pengajuan / Ujian..." />
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div id='btn_add' class="btn btn-primary">Baru</div>                                                                                    </div>
