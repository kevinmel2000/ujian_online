<?php /*%%SmartyHeaderCode:2985457ccc8fa8c7af1-93421716%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f8decce4a631f899fe49f8b8d9d05152b8b8b54' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\soal\\list.html',
      1 => 1515029489,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2985457ccc8fa8c7af1-93421716',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a531e583a9bb5_85865620',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a531e583a9bb5_85865620')) {function content_5a531e583a9bb5_85865620($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Ujian | Daftar Ujian</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Ujian <small>Daftar Ujian</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/soal/">Ujian</a></li>
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" value="" name="id_jurusan" id="jurusan" />
                                                        <input type="text" value="" class="form-control" name="nama_jurusan" placeHolder="Ketik untuk memilih jurusan..." />
                                                    </td>                                                    
                                                </tr>
                                                <tr>
                                                    <td><label for="subjurusan">Sub Jurusan:</label></td>
                                                    <td>
                                                        <input type="hidden" value="" name="id_subjurusan" id="subjurusan" />
                                                        <input type="text" value="" class="form-control" name="nama_subjurusan" placeHolder="Ketik untuk memilih sub jurusan..." />
                                                    </td>                                                    
                                                </tr>
                                                <tr>
                                                    <td><label for="kelas">Kelas:</label></td>
                                                    <td>
                                                        <input type="hidden" value="" name="id_kelas" id="kelas" />
                                                        <input type="text" value="" class="form-control" name="nama_kelas" placeHolder="Ketik untuk memilih kelas..."   />
                                                    </td>
                                                </tr>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="20%"><div style="text-align: left;">Pelajaran</div></th>
                                                            <th width="25%"><div style="text-align: left;">Nama Ujian<br />Kode Soal</div></th>
                                                            <th width="10%"><div style="text-align: center;">Waktu Ujian</div></th>
                                                            <th width="5%"><div style="text-align: center;">Soal</div></th>
                                                            <th width="10%"><div style="text-align: center;">Detail Soal</div></th>                                                        
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_2">
                                                                ...
                                                                <td align="left">SDN Negeri 486 Jakarta<br /><small>Pendidikan Dasar / Kelas Satu / Dua</small></td>
                                                                <td align="left">Bahasa Inggris<br /><label class="label label-warning">ujian ditayangkan</label></td>
                                                                <td align="left">Ujian Kenaikan Kelas Bahasa Inggris<br /><small>Kode: BI0102001</small></td>
                                                                <td align="center">08-01-2017<br />09:00</td>                                                                
                                                                <td align="center">7</td>
                                                                <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                    <div id_select="2" class="btn btn-success edit">Detail Soal</div>
                                                                </div></td>                                                                                                       
                                                            </tr>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="left">SDN Negeri 486 Jakarta<br /><small>Pendidikan Dasar / Kelas Satu / Dua</small></td>
                                                                <td align="left">Biologi<br /><label class="label label-warning">ujian ditayangkan</label>&nbsp;&nbsp;<label class="label label-danger">nilai ditayangkan</label></td>
                                                                <td align="left">Ujian Saringan Masuk Biologi<br /><small>Kode: B-001</small></td>
                                                                <td align="center">23-01-2017<br />19:30</td>                                                                
                                                                <td align="center">17</td>
                                                                <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                    <div id_select="1" class="btn btn-success edit">Detail Soal</div>
                                                                </div></td>                                                                                                       
                                                            </tr>
                                                            ...
                                                            <tr id="baris_5">
                                                                ...
                                                                <td align="left">Ujian Bahasa Indonesia<br /><small>Kode: A1109</small></td>
                                                                <td align="center">14-01-2018<br />03:50</td>                                                                
                                                                <td align="center"></td>
                                                                <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                    <div id_select="5" class="btn btn-success edit">Detail Soal</div>
                                                                </div></td>                                                                                                       
                                                            </tr>
                                                            ...
                                                            <tr id="baris_3">
                                                                ...
                                                                <td align="left">SDN Negeri 486 Jakarta<br /><small>Pendidikan Dasar / Kelas Satu / Dua</small></td>
                                                                <td align="left">Agama Islam<br /><label class="label label-warning">ujian ditayangkan</label></td>
                                                                <td align="left">Ujian Masuk Agama Islam<br /><small>Kode: AG0001</small></td>
                                                                <td align="center">22-01-2017<br />10:00</td>                                                                
                                                                <td align="center"></td>
                                                                <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                    <div id_select="3" class="btn btn-success edit">Detail Soal</div>
                                                                </div></td>                                                                                                       
                                                            </tr>
                                                            ...
                                                            <tr id="baris_4">
                                                                ...
                                                                <td align="left">SDN Negeri 486 Jakarta<br /><small>Pendidikan Dasar / Kelas Satu / Satu</small></td>
                                                                <td align="left">Matematika<br /><label class="label label-warning">ujian ditayangkan</label>&nbsp;&nbsp;<label class="label label-danger">nilai ditayangkan</label></td>
                                                                <td align="left">Ujian Kenikan Kelas 2<br /><small>Kode: U001</small></td>
                                                                <td align="center">19-02-2017<br />13:30</td>                                                                
                                                                <td align="center">3</td>
                                                                <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                    <div id_select="4" class="btn btn-success edit">Detail Soal</div>
                                                                </div></td>                                                                                                       
                                                            </tr>
                                                            ...
                                                            <tr id="baris_6">
                                                                ...
                                                                <td align="left">SDN Negeri 486 Jakarta<br /><small>Pendidikan Dasar / Kelas Satu / Satu</small></td>
                                                                <td align="left">Biologi<br /><label class="label label-warning">ujian ditayangkan</label></td>
                                                                <td align="left">Tes Ujian Biologi<br /><small>Kode: AAGYM</small></td>
                                                                <td align="center">08-01-2018<br />14:30</td>                                                                
                                                                <td align="center">1</td>
                                                                <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                    <div id_select="6" class="btn btn-success edit">Detail Soal</div>
                                                                </div></td>                                                                                                       
                                                            </tr>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#btn_cari" ).click(function() {
                ...
                window.location='list.php?'+(query.length>0?'&query='+query:'')+(sekolah.length>0?'&id_sekolah='+sekolah:'')+(jurusan.length>0?'&id_jurusan='+jurusan:'')+(subjurusan.length>0?'&id_subjurusan='+subjurusan:'')+(kelas.length>0?'&id_kelas='+kelas:'');
            });
            ...
            $( ".edit" ).click(function() {
                var id = this.getAttribute('id_select');
                window.location='http://localhost/ujian_online/pilihanganda/list.php?id='+id;
            });
            ...
            setMessage('success', 'Edit soal berhasil.');        
