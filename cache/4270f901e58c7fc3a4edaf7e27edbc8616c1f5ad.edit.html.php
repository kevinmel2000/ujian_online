...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4f30c3753e27_62377941',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4f30c3753e27_62377941')) {function content_5a4f30c3753e27_62377941($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Guru | Setting Guru</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Guru <small>Setting Guru</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/guru/">Guru</a></li>
                    <li class="active">Setting Guru</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="Pendidikan Dasar" class="form-control" name="nama_jurusan" readonly='readOnly' />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="subjurusan">Sub Jurusan:</label>
                                            <input type="hidden" value="1" name="id_subjurusan" />
                                            <input type="text" value="Kelas Satu" class="form-control" name="nama_subjurusan" readonly='readOnly' />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nik">NIK:</label>
                                            <input type="text" value="0909211001" class="form-control" name="nik" readonly='readOnly' />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama">Nama Guru:</label>
                                            <input type="text" value="Arsali" class="form-control" name="nama" readonly='readOnly' />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a id="btn_batal"  href="http://localhost/ujian_online/guru/list.php" class="btn btn-warning">Batal</a>                                            
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
        ...
        $(function () {           
            ...
            $('.tanggal').datepick({ dateFormat: 'dd-mm-yyyy' });
                    ...
                    '<tr>' +
                        ...
                        '<td align="center">' +
                            '<input type="text" value="Pendidikan Dasar" class="form-control nama_jurusan" name="jurusan" readonly="readOnly" />' +                                                
                            '<input type="hidden" value="1" name="id_jurusan" />' +
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Kelas Satu" class="form-control nama_subjurusan" name="subjurusan" readonly="readOnly" />' +                                                
                            '<input type="hidden" value="1" name="id_subjurusan" />' +
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Dua" class="form-control nama_kelas" name="kelas" />' +                                                
                            '<input type="hidden" value="2" name="id_kelas" />' +                       
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Bahasa Indonesia" class="form-control nama_pelajaran" name="pelajaran" />' +                                                
                            '<input type="hidden" value="6" name="id_pelajaran" />' +         
                        '</td>' +
                    '</tr>';
                $( record ).insertBefore( "#detail_pelajaran" );
                    ...
                    '<tr>' +
                        ...
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Agama Islam" class="form-control nama_pelajaran" name="pelajaran" />' +                                                
                            '<input type="hidden" value="7" name="id_pelajaran" />' +         
                        '</td>' +
                    '</tr>';
                $( record ).insertBefore( "#detail_pelajaran" );
                            var record = 
                    '<tr>' +
                        ...
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Satu" class="form-control nama_kelas" name="kelas" />' +                                                
                            '<input type="hidden" value="1" name="id_kelas" />' +                       
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Matematika" class="form-control nama_pelajaran" name="pelajaran" />' +                                                
                            '<input type="hidden" value="8" name="id_pelajaran" />' +         
                        '</td>' +
                    '</tr>';
                $( record ).insertBefore( "#detail_pelajaran" );
                            var record = 
                    '<tr>' +
                        ...
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" value="Biologi" class="form-control nama_pelajaran" name="pelajaran" />' +                                                
                            '<input type="hidden" value="9" name="id_pelajaran" />' +         
                        '</td>' +
                    '</tr>';
                $( record ).insertBefore( "#detail_pelajaran" );
                        setAutocomplete();
            ...
            $('#btn_add').click(function() {
                var record = 
                    '<tr>' +
                        '<td align="center"><span class="fa fa-trash-o hapus_detail" style="cursor: pointer;"></span></td>' +                                            
                        '<td align="center">' +
                            '<input type="text" class="form-control nama_jurusan" name="jurusan" value="Pendidikan Dasar" readonly="readOnly" />' +                                                
                            '<input type="hidden" name="id_jurusan" value="1" />' +
                        '</td>' +
                        '<td align="center">' +
                            '<input type="text" class="form-control nama_subjurusan" name="subjurusan" value="Kelas Satu" readonly="readOnly" />' +                                                
                            '<input type="hidden" name="id_subjurusan" value="1" />' +
                        '</td>' +
                        '<td align="center">' +
            ...
            function setAutocomplete() {
                ...
                $('.nama_pelajaran').autocomplete({                
                    source: function( request, response ) {
                        ...
                        $.ajax({
                            url: 'http://localhost/ujian_online/store/pelajaranDataStore.php',
                            dataType: "json",
                            method: 'post',
                            data: {
                                query: request.term,
            ...
            $('#btn_simpan').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data['success']) {
                            window.location = 'http://localhost/ujian_online/guru/list.php';                    
                        } else {
                            setLoading(false);
