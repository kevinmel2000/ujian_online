...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_579ffb7cee3c14_31415650',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_579ffb7cee3c14_31415650')) {function content_579ffb7cee3c14_31415650($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Left Widget <small>List of Left Widget</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/contentleft/">Left Widget</a></li>
                          <li class="active">List of Left Widget</li>
                        </ol -->
                    </div>
                </div>
                        ...
                        <ul>
                            ...
                            <li id="arrayorder_2">
                                <div class="image_widget">
                                    <!-- img src="http://192.168.1.101/gomocart/adminweb/images/widget/more.png" width="450px" / -->
                                    <img src="http://192.168.1.101/gomocart/templates/back-end/matrix/assets/img/category.png" width="570px" />
                                    <div class="title_widget">Batu Arang</div>
                                    <div class="kolom_widget">Kategori</div>
                            ...
                            <li id="arrayorder_3">
                                <div class="image_widget">
                                    <!-- img src="http://192.168.1.101/gomocart/adminweb/images/widget/more.png" width="450px" / -->
                                    <img src="http://192.168.1.101/gomocart/templates/back-end/matrix/assets/img/category.png" width="570px" />
                                    <div class="title_widget">Pembayaran</div>
                                    <div class="kolom_widget">Pembayaran</div>
                                    <div class="aksi_widget">
                            ...
                            <li id="arrayorder_4">
                                <div class="image_widget">
                                    <!-- img src="http://192.168.1.101/gomocart/adminweb/images/widget/more.png" width="450px" / -->
                                    <img src="http://192.168.1.101/gomocart/templates/back-end/matrix/assets/img/category.png" width="570px" />
                                    <div class="title_widget">Ekspedisi</div>
                                    <div class="kolom_widget">Ekspedisi</div>
                                    <div class="aksi_widget">
                            ...
                            <li id="arrayorder_1">
                                <div class="image_widget">
                                    <!-- img src="http://192.168.1.101/gomocart/adminweb/images/widget/more.png" width="450px" / -->
                                    <img src="http://192.168.1.101/gomocart/templates/back-end/matrix/assets/img/category.png" width="570px" />
                                    <div class="title_widget">Energi</div>
                                    <div class="kolom_widget">Kategori</div>
                                    <div class="aksi_widget">
