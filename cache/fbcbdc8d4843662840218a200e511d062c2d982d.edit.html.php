...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a6e74c190999_20628120',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a6e74c190999_20628120')) {function content_57a6e74c190999_20628120($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb/pengajuansertifikat/">Pengajuan Sertifikat</a></li>
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" value="07-08-2016" class="form-control tanggal" name="tanggal_pengajuan" placeholder="Tanggal Pengajuan" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><label for="jadual_ujian">Jadwal Ujian:</label></td>
                                                    <td>
                                                        <input type="text" value="05-08-2016 (Kota Bogor)" class="form-control" name="ujian" readonly />
                        ...
                        '<div class="row">' +
                            '<div class="col-md-12">' +
                                '<div class="col-md-3 no-padding">' +
                                    '<input type="text" class="form-control taekwondo" value="Akuilah Dermato" name="taekwondo" placeholder="Peserta Taekwondo" />' +
                                    '<input type="hidden" value="1" name="id_taekwondo" />' +                                        
                                '</div>' +
                                '<div class="col-md-2 no-padding">' +
                                    '<input type="text" class="form-control" value="1209-02321" name="no_reg" readonly placeholder="No. Registrasi" />' +
                                '</div>' +
                                '<div class="col-md-4 no-padding">' +
                                    '<input type="text" class="form-control" value="Tegal, 05-08-2016" name="ttl" readonly placeholder="Tempat, Tanggal Lahir" />' +
                                '</div>' +
                                '<div class="col-md-3 no-padding">' +
                                    '<div class="input-group">' +
                                        '<input type="text" class="form-control text-center" value="27" name="geup" placeholder="No. Geup" />' +
            ...
            function setAutocomplete() {
                ...
                $('[name=taekwondo]').autocomplete({
                    source: function( request, response ) {
                        ...
                        $.ajax({
                            url: 'http://192.168.1.100/sertifikat_online/store/pesertaDataStore.php',
                            dataType: "json",
                            method: 'post',
                            data: {
                                query: request.term,
