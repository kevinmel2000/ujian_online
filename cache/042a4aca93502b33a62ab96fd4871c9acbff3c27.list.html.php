<?php /*%%SmartyHeaderCode:3161557ccc9fd93b505-04140679%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '042a4aca93502b33a62ab96fd4871c9acbff3c27' => 
    array (
  ...
  'nocache_hash' => '3161557ccc9fd93b505-04140679',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a4c1df548f3c3_99684599',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4c1df548f3c3_99684599')) {function content_5a4c1df548f3c3_99684599($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Admin User | Daftar Admin User</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Admin User <small>Daftar Admin User</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/pengguna/">Admin User</a></li>
                    <li class="active">Daftar Admin User</li>
                </ol>
            </section>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="30%"><div style="text-align: center;">Nama Admin</div></th>
                                                            <th width="30%"><div style="text-align: center;">Username</div></th>
                                                            <th width="35%"><div style="text-align: center;">Sekolah</div></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="left">Super Administrator</td>
                                                            ...
                                                            <tr id="baris_2">
                                                                ...
                                                                <td align="left">Admin Sekolah</td>
                                                                <td align="left">adminsekolah</td>
                                                                <td align="left">SDN Negeri 486 Jakarta</td>                                                                                                         
                                                            </tr>
                                                            ...
                                                            <tr id="baris_7">
                                                                ...
                                                                <td align="left">Admin SMAN 14 Depok</td>
                                                                <td align="left">sman14depok</td>
                                                                <td align="left">SMA NEGERI 14 DEPOK</td>                                                                                                         
                                                            </tr>
