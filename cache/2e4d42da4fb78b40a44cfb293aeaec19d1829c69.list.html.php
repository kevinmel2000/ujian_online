<?php /*%%SmartyHeaderCode:11601578d9c13d2cd65-01249353%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2e4d42da4fb78b40a44cfb293aeaec19d1829c69' => 
    array (
      0 => '..\\..\\templates\\back-end\\matrix\\laporan_pembayaran\\list.html',
      1 => 1470099031,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11601578d9c13d2cd65-01249353',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a01b899eca64_64166381',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a01b899eca64_64166381')) {function content_57a01b899eca64_64166381($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Laporan Pembayaran <small>List of Laporan Pembayaran</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/laporan_pembayaran/">Laporan Pembayaran</a></li>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%"><div style="text-align: center;">No. Pesan</div></th>
                                        <th width="15%"><div style="text-align: center;">Tanggal Bayar</div></th>
                                        <th width="25%"><div style="text-align: center;">Dari Member</div></th>
                                        <th width="25%"><div style="text-align: center;">Tujuan</div></th>
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_4">
                                            ...
                                            <td align="left">BCA<!-- cabang Pasar Cisalak<br />An. Nur Azizah (1662984244) --></td>
                                            <td align="right"><span style="font-weight: bold;">57,000</span></td>                                                                                   
                                        </tr>
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td align="left">Kiezie Ok</td>
                                            <td align="left">BCA<!-- cabang Pasar Cisalak<br />An. Nur Azizah (1662984244) --></td>
                                            <td align="right"><span style="font-weight: bold;">240,545</span></td>                                                                                   
                                        </tr>
                                        ...
                                        <tr id="baris_3">
                                            ...
                                            <td align="center">13-07-2016</td>
                                            <td align="left">Kiezie Ok</td>
                                            <td align="left">Bank Mandiri<!-- cabang Simpang Depok<br />An. Rifkhi Heruprasetyo (1570001339200) --></td>
                                            <td align="right"><span style="font-weight: bold;">156,700</span></td>                                                                                   
                                        </tr>
                                        ...
                                        <tr id="baris_5">
                                            ...
                                            <td align="left">Kiezie Ok</td>
                                            <td align="left">Bank Mandiri<!-- cabang Simpang Depok<br />An. Rifkhi Heruprasetyo (1570001339200) --></td>
                                            <td align="right"><span style="font-weight: bold;">115,105</span></td>                                                                                   
                                        </tr>
                                          
                                                                        <tr>
                                        <td colspan="5" align="right"><span style="font-weight: bold;">TOTAL:&nbsp;&nbsp;</span></td>
                                        <td align="right"><span style="font-weight: bold;">569,350</span></td>                                        
                                    </tr>
                                </tbody>
                                                        </table>
                    </div>
            ...
            $( "#ekspor_xls" ).click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        if(data['success']) {
                            window.location = 'http://192.168.1.101/gomocart/adminweb/readFile.php?name=' + data['filename'];
                        } else {
