<?php /*%%SmartyHeaderCode:952157bb7374ea9241-55432690%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b9bb19a24cd899e150e6a60bd9b35397eb08a7f' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\pengguna\\list.html',
      1 => 1471903367,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '952157bb7374ea9241-55432690',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57c5881becab41_70662796',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c5881becab41_70662796')) {function content_57c5881becab41_70662796($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Pengguna | Daftar Pengguna</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header"> MENU </li>
                    <li class="treeview">
                <a href="http://192.168.1.100/pelaporan_pelanggaran/dashboard/"><i class="fa fa-dashboard"></i> <span>Halaman Depan</span> </a>
                            </li>
                    <li class="treeview">
                <a href="http://192.168.1.100/pelaporan_pelanggaran/rekapitulasipelaporan/"><i class="fa fa-bars"></i> <span>Rekapitulasi</span> </a>
                            </li>
                    <li class="active treeview">
                <a href="http://192.168.1.100/pelaporan_pelanggaran/pengguna/"><i class="fa fa-user"></i> <span>Pengaturan Pengguna</span> </a>
                            </li>
                    <li class="treeview">
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Pengguna <small>Daftar Pengguna</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.100/pelaporan_pelanggaran">Home</a></li>
                    <li><a href="http://192.168.1.100/pelaporan_pelanggaran/pengguna/">Pengguna</a></li>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="25%"><div style="text-align: center;">Pengguna</div></th>
                                                            <th width="25%"><div style="text-align: center;">Username</div></th>
                                                            <th width="15%"><div style="text-align: center;">Password</div></th>
                                                            <th width="30%"><div style="text-align: center;">Propinsi / Kabupaten Kota</div></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_4">
                                                                ...
                                                                <td align="left">Simual-mual</td>
                                                                <td align="left">simual</td>
                                                                <td align="left">simual123</td>
                                                                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kota Jakarta Timur</td>                                                                                                         
                                                            </tr>
                                                            ...
                                                            <tr id="baris_2">
                                                                ...
                                                                <td align="left">tesuser</td>
                                                                <td align="left">123456</td>
                                                                <td align="left"><b>Jawa Barat</b></td>                                                                                                         
                                                            </tr>
                                                            ...
                                                            <tr id="baris_3">
                                                                ...
                                                                <td align="left">BKD Kota Depok</td>
                                                                <td align="left">kiezie</td>
                                                                <td align="left">qwe123</td>
                                                            ...
                                                            <tr id="baris_5">
                                                                ...
                                                                <td align="left">BKD Kota Depok</td>
                                                                <td align="left">bkd_kotadepok</td>
                                                                <td align="left">kotadepok123</td>
                                                                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kota Depok</td>                                                                                                         
                                                            </tr>
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <!-- LOAD MASKING -->
    <link href="http://192.168.1.100/pelaporan_pelanggaran/templates/back-end/AdminLTE-2.3.6/dist/css/loadmask.css" rel="stylesheet" />
    <script src="http://192.168.1.100/pelaporan_pelanggaran/templates/back-end/AdminLTE-2.3.6/dist/js/jquery.loadmask.min.js"></script>
