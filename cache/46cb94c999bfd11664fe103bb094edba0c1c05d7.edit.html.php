...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a6ec4216d3f7_72611308',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a6ec4216d3f7_72611308')) {function content_57a6ec4216d3f7_72611308($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Nomer Registrasi | Detail of Nomer Registrasi</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Nomer Registrasi <small>Detail of Nomer Registrasi</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Detail of Nomer Registrasi</li>
                </ol>
            </section>
                            ...
                            <div class="box-body">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <!-- tr>
                                                    ...
                                                    <td><b>Kota Bogor</b> <br />Desa suka maju waluyo Jangkar B. 20 Bogor Jawa barat</td>
                                                </tr -->
                                                <tr>
                                                    <td><label for="jadual_ujian">Jadwal Ujian:</label></td>
                                                    <td>05-08-2016 / Kota Bogor</td>
                                                </tr>
                                            </table>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-3 no-padding">
                                                        <input type="text" value="" class="form-control tanggal" name="tanggal" placeholder="Klik Untuk Memilih Tanggal Lahir..." />
                                                    </div>
                                                    <div class="col-md-9 no-padding">
                                                        <div class="input-group">
                                                            ...
                                                            <a class="btn btn-default" href="edit.php?id=1">Reset</a></span>                                                  
                                                        </div>
                                                    </div>
                                                </div>        
                                            </div>                                            
                                        ...
                                        <div class="form-group">
                                            <div id='btn_add' class="btn btn-primary">Baru</div>                                            <div id='btn_edit' class="btn btn-success disabled">Lihat</div>                                        </div -->
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="left">Tegal</td>
                                                                <td align="center">05-08-2016</td>
                                                                <td align="center">27</td>
                                                                <td align="left"><input type="text" value="1209-02321" class="form-control no_reg text-center" name="no_reg" /><input type="hidden" value="1" name="id_taekwondo" /></td>                                                                
                                                                <td><div style="text-align: center;  white-space: nowrap;">
                                                                                                                                                    <div class="i_loading" style="display: none;"><img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/loading.gif" /></div>
