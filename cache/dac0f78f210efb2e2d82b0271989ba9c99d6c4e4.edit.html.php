...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4d7067613c75_21406526',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4d7067613c75_21406526')) {function content_5a4d7067613c75_21406526($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Guru | Edit Data Guru</title>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="1121200" class="form-control" name="nik" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama">Nama Guru:</label>
                                            <input type="text" value="Kiezi S.sos" class="form-control" name="nama" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="no_hp">No. HP:</label>
                                            <input type="text" value="09092212" class="form-control" name="no_hp" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="kiezieaa" class="form-control" name="username" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="password">Password:</label>
                                            <input type="text" value="146460" class="form-control" name="password" />
                                        </div>
