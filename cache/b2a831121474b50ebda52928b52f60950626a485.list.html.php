...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a531e05de5313_27767114',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a531e05de5313_27767114')) {function content_5a531e05de5313_27767114($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Ujian | Daftar Soal Pilihan Ganda</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Ujian <small>Daftar Soal Pilihan Ganda</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Daftar Soal Pilihan Ganda</li>
                </ol>
            </section>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <ul id="myTab" class="nav nav-tabs">                                
                                                ...
                                                <li>
                                                    <a href="http://localhost/ujian_online/essai/list.php?id=6"><b>Essai</b></a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="form-group tab-content">
                                            <div class="tab-pane fade active in" id="pilihanganda">
                                                ...
                                                <div class="form-group">
                                                    <div id='btn_add' class="btn btn-primary">Baru</div>                                                    <a href="http://localhost/ujian_online/soal" class="btn btn-primary pull-right">Kembali</a>
                                                </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <tr id="baris_58">
                                                                        ...
                                                                        <td align="left"><p>Pertanyaannya&nbsp;&nbsp; ?&nbsp;&nbsp; <br></p></td> 
                                                                        <td align="center">C</td>
                                                                        <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                                            <div id_select="58" class="btn btn-success edit">Edit</div>                                                                            <div id_select="58" class="btn btn-danger hapus">Hapus</div>                                                                        </div></td>
                                                                    </tr>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#btn_add" ).click(function() {
                window.location='add.php?id_head=6';
            });
            ...
            $( ".edit" ).click(function() {
                var id = this.getAttribute('id_select');
                window.location='edit.php?id_head=6&id='+id;
            });
