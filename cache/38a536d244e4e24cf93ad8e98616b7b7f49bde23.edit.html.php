<?php /*%%SmartyHeaderCode:27965a4c4f5dc6e1f3-40210052%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38a536d244e4e24cf93ad8e98616b7b7f49bde23' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\subjurusan\\edit.html',
      1 => 1514950625,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '27965a4c4f5dc6e1f3-40210052',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a4c51494ba623_94672036',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4c51494ba623_94672036')) {function content_5a4c51494ba623_94672036($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Sub Jurusan | Edit Data Sub Jurusan</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Sub Jurusan <small>Edit Data Sub Jurusan</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/jurusan/">Jurusan</a></li>
                    <li><a href="http://localhost/ujian_online/subjurusan/">Sub Jurusan</a></li>
                    <li class="active">Edit Data Sub Jurusan</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="SDN Negeri 486 Jakarta" class="form-control" readonly="readOnly" />
                                        </div>
                    
                                        <div class="form-group">
                                            <label for="jurusan">Jurusan:</label>
                                            <input type="text" value="Pendidikan Dasar" class="form-control" readonly="readOnly" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kode">Kode Sub Jurusan:</label>
                                            <input type="text" value="Kelas 1" class="form-control" name="kode" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama">Nama Sub Jurusan:</label>
                                            <input type="text" value="Kelas 1" class="form-control" name="nama" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a id="btn_batal"  href="list.php?id_jurusan=1" class="btn btn-warning">Batal</a>                                            
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
            ...
            $('#btn_simpan').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data['success']) {
                            window.location = 'list.php?id_jurusan=1';                    
                        } else {
                            setLoading(false);
