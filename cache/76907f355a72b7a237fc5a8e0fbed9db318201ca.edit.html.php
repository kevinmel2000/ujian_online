...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4c7e2bb1ead3_97734878',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4c7e2bb1ead3_97734878')) {function content_5a4c7e2bb1ead3_97734878($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Sub kelas | Edit Data Sub kelas</title>
      ...
      <ul class="sidebar-menu">
        <li class="header"> MENU </li>
                ...
                <a href="http://localhost/ujian_online/kelas/"><i class="fa fa-edit"></i> <span>Kelas</span> </a>
                    ...
                    <li class="treeview">
                <a href="http://localhost/ujian_online/ruang/"><i class="fa fa-edit"></i> <span>Ruang</span> </a>
                            </li>
                    <li class="treeview">
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Sub kelas <small>Edit Data Sub kelas</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Data Sub kelas</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="Kelas Satu" class="form-control" readonly="readOnly" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kelas">Kelas:</label>
                                            <input type="text" value="Satu" class="form-control" readonly="readOnly" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kode">Kode Sub Kelas:</label>
                                            <input type="text" value="XSa1121" class="form-control" name="kode" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama">Nama Sub Kelas:</label>
                                            <input type="text" value="Kelas Sati ssr AS" class="form-control" name="nama" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a id="btn_batal"  href="list.php?id_kelas=1" class="btn btn-warning">Batal</a>                                            
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
