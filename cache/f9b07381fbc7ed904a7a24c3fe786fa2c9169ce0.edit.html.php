<?php /*%%SmartyHeaderCode:1178157be7927c60ce1-29006746%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9b07381fbc7ed904a7a24c3fe786fa2c9169ce0' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\pengumuman\\edit.html',
      1 => 1472100527,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1178157be7927c60ce1-29006746',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57be79c605e093_78770977',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57be79c605e093_78770977')) {function content_57be79c605e093_78770977($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Pengumuman | Edit Pengumuman</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Pengumuman <small>Edit Pengumuman</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.101/pelaporan_pelanggaran">Home</a></li>
                    <li><a href="http://192.168.1.101/pelaporan_pelanggaran/pengumuman/">Pengumuman</a></li>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="25-08-2016" class="form-control tanggal" name="tanggal" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="pengumuman">Pengumuman:</label>
                                            <textarea class="form-control" name="pengumuman" style="height: 100px;">Tes Isi Pengumuman</textarea>
                                        </div>
    ...
    <script type="text/javascript">
        $(function () {           
            ...
            $('#btn_simpan').click(function() {
                ...
                data.append('pengumuman', $('[name=pengumuman]').val());
