...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a098797179b7_18629432',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a098797179b7_18629432')) {function content_57a098797179b7_18629432($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Metode Pembayaran <small>List of Metode Pembayaran</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/transferbank/">Metode Pembayaran</a></li>
                          <li class="active">List of Metode Pembayaran</li>
                        </ol -->
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td align="left">BCA<br />Cabang Pasar Cisalak</td>
                                            ...
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/bank/bca_7941.png" width="75" />
                                            </div></td>
                                        ...
                                        <tr id="baris_1">
                                            ...
                                            <td align="left">Bank Mandiri<br />Cabang Simpang Depok</td>
                                            <td align="center">1570001339200</td>
                                            <td align="center">Rifkhi Heruprasetyo</td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/bank/bank-mandiri_7286.png" width="75" />
                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
