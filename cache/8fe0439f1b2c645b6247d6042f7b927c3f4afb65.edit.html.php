<?php /*%%SmartyHeaderCode:2918657a6a975472dc4-23586913%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8fe0439f1b2c645b6247d6042f7b927c3f4afb65' => 
    array (
      0 => '..\\..\\templates\\back-end\\AdminLTE-2.3.6\\pesertaujian\\edit.html',
      1 => 1470555133,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2918657a6a975472dc4-23586913',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a6e9739940b6_97089471',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a6e9739940b6_97089471')) {function content_57a6e9739940b6_97089471($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Peserta Ujian | Edit of Peserta Ujian</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Peserta Ujian <small>Edit of Peserta Ujian</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb">Home</a></li>
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb/pesertaujian/">Peserta Ujian</a></li>
                    <li class="active">Edit of Peserta Ujian</li>
                </ol>
            </section>
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" value="" class="form-control" name="ujian" placeholder="Jadwal Ujian" />
                                                        <input type="hidden" value="" name="id_ujian" />
                                                    </td>
                                                </tr>
                                                                                                <tr>
                                                    <td><label for="peserta">Peserta:</label></td>
                                                    <td>
                                                        <div class="col-md-9 no-padding">
                                                            <input type="text" class="form-control" value="" name="taekwondo" placeholder="Peserta Taekwondo" />
                                                            <input type="hidden" value="" name="id_taekwondo" />
                                                        </div>
                                                        <div class="col-md-3 no-padding">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" value="" name="geup" placeholder="No. Geup" />
                                                                <span class="input-group-btn">
                                                                    <div id="i_loading" style="padding: 0 10px 0 10px; display: none;"><img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/loading.gif" /></div>
                                                                    <div id="btn_simpan" class="btn btn-primary">Tambah</div>
                                                                </span>                  
                                                            </div>
                                                        </div>                                                        
                                                    </td>       
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <script type="text/javascript" src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/js/notifIt.js"></script>
    <link rel="stylesheet" type="text/css" href="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/css/notifIt.css">
    
    <!-- LOAD MASKING -->
    <link href="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/css/loadmask.css" rel="stylesheet" />
    <script src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/js/jquery.loadmask.min.js"></script>
    ...
    <script type="text/javascript">
        $(function () {           
            ...
            $( "#btn_cari" ).click(function() {
                var query = $( "#query" ).val();
                window.location='edit.php?id='+(query.length>0?'&query='+query:'');
            });
            ...
            $('[name=ujian]').autocomplete({
                source: function( request, response ) {
                    $.ajax({
                        url: 'http://192.168.1.100/sertifikat_online/store/jadwalujianDataStore.php',
                        dataType: "json",
                        method: 'post',
                        data: {
                            query: request.term
            ...
            $('[name=taekwondo]').autocomplete({
                source: function( request, response ) {
                    $.ajax({
                        url: 'http://192.168.1.100/sertifikat_online/store/taekwondoDataStore.php',
                        dataType: "json",
                        method: 'post',
                        data: {
                            query: request.term
            ...
            $('#btn_simpan').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data['success']) {
                            window.location = 'edit.php?id='+$('[name=id_ujian]').val()+'&page=1';                    
                        } else {
                            setLoadingAdd(false);
                            setMessage('error', data['message']);                        
                        }
            ...
            function setLoadingAdd(isLoading) {
                if(isLoading) {
                    $('#i_loading').show();
                    $('#btn_simpan').hide();
                } else {
            ...
            $('.update').click(function() {
                ...
                var element = $(this).closest('tr');
                var id = element.find('[name=id_peserta]').val();
                var geup = element.find('[name=geup]').val(); 
                var button = element.find('.update');
                var i_loading = element.find('.i_loading_update');
        
                var data = new FormData();
                data.append('id', id);
                data.append('geup', geup);
