...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4f4b2f7a0205_65812220',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4f4b2f7a0205_65812220')) {function content_5a4f4b2f7a0205_65812220($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Koreksi | Daftar Siswa</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Koreksi <small>Daftar Siswa</small>
                </h1>
                <ol class="breadcrumb">
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="10%"><div style="text-align: center;">Edit</div></th>                                                        
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_2">
                                                                ...
                                                                <td align="center">010102</td>
                                                                <td align="left">Rifki Heru B</td>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#btn_cari" ).click(function() {
                var query = $( "#query" ).val();
                window.location='list.php?id=4&'+(query.length>0?'&query='+query:'');
            });

            $( ".edit" ).click(function() {
                var id = this.getAttribute('id_select');
                window.location='http://localhost/ujian_online/koreksi_siswa/edit.php?id='+id;
            });
