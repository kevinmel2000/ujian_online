...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4c77a7de5e76_50833167',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4c77a7de5e76_50833167')) {function content_5a4c77a7de5e76_50833167($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Kelas | Edit Data kelas</title>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="2" name="id_subjurusan" />
                                            <input type="text" value="Kelas 2" class="form-control" name="nama_subjurusan" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kode">Kode kelas:</label>
                                            <input type="text" value="11123" class="form-control" name="kode" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama">Nama kelas:</label>
                                            <input type="text" value="Satu" class="form-control" name="nama" />
                                        </div>
