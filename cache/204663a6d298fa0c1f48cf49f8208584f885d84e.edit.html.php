...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a6d87f9fcb59_69262118',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a6d87f9fcb59_69262118')) {function content_57a6d87f9fcb59_69262118($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Pengajuan Sertifikat | Edit of Pengajuan Sertifikat</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Pengajuan Sertifikat <small>Edit of Pengajuan Sertifikat</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb">Home</a></li>
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb/pesertaujian/">Pengajuan Sertifikat</a></li>
                    <li class="active">Edit of Pengajuan Sertifikat</li>
                </ol>
            </section>
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" value="05-08-2016 (Kota Bogor)" class="form-control" name="ujian" placeholder="Jadwal Ujian" />
                                                        <input type="hidden" value="1" name="id_ujian" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="5%"><div style="text-align: center;">Hapus</div></th>                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="left">Akuilah Dermato</td>
                                                                <td align="center">1209-02321</td>
                                                                <td align="center">Tegal / 05-08-2016</td>
                                                                <td align="center">12</td>                                                                
                                                                
                                                                                                                                <td><div style="text-align: center;  white-space: nowrap;">
                                                                            <div class="i_loading_delete" style="display: none;"><img src="http://192.168.1.100/sertifikat_online/templates/back-end/AdminLTE-2.3.6/dist/img/loading.gif" /></div>
