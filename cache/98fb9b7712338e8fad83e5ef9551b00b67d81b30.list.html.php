...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4ca1c1810ea0_82013352',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4ca1c1810ea0_82013352')) {function content_5a4ca1c1810ea0_82013352($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Sub Jurusan | Daftar Sub Jurusan</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Sub Jurusan <small>Daftar Sub Jurusan</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Daftar Sub Jurusan</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="http://localhost/ujian_online/jurusan" class="btn btn-primary pull-right">Kembali ke Jurusan</a>
                                        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#btn_add" ).click(function() {
                window.location='add.php?id_jurusan=1';
            });
            ...
            $( "#btn_cari" ).click(function() {
                var query = $( "#query" ).val();
                window.location='list.php?id_jurusan=1&'+(query.length>0?'&query='+query:'');
            });
