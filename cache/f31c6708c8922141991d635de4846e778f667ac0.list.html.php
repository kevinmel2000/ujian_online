<?php /*%%SmartyHeaderCode:252385782f7af009306-31380221%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f31c6708c8922141991d635de4846e778f667ac0' => 
    array (
      0 => '..\\..\\templates\\back-end\\matrix\\ekspedisi\\list.html',
      1 => 1470139931,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '252385782f7af009306-31380221',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a27bd961a156_76414898',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a27bd961a156_76414898')) {function content_57a27bd961a156_76414898($_smarty_tpl) {?><!DOCTYPE html>
...
<body>
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            ...
            <ul class="nav navbar-top-links navbar-right">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                        <i class="fa fa-tasks fa-fw"></i> <span>Pesanan Baru </span> <span id="total_new_order" class="label label-danger" >3</span> <i class="fa fa-caret-down"></i>
                    </a>
                    ...
                    <input type="hidden" name="last_id_order" value="11" />
                    <!-- /.dropdown-tasks -->
                </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Ekspedisi <small>List of Ekspedisi</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/ekpedisi">Ekspedisi</a></li>
                          <li class="active">List of Ekspedisi</li>
                        </ol -->
                    </div>
                </div>
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_5">
                                            ...
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/ekspedisi/jnt_3729.png" width="75px" />                                            </div></td>
                                        ...
                                        <tr id="baris_4">
                                            ...
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/ekspedisi/wahana_7823.png" width="75px" />                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                        ...
                                        <tr id="baris_3">
                                            ...
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/ekspedisi/pos_1684.png" width="75px" />                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/ekspedisi/tiki_1683.png" width="75px" />                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                        ...
                                        <tr id="baris_1">
                                            ...
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>
                                            <td align="center"><div style="text-align: center;  white-space: nowrap;">
                                                <img src="http://192.168.1.101/gomocart/uploads/ekspedisi/jne_7861.png" width="75px" />                                            </div></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            setMessage('success', 'Tambah ekspedisi baru berhasil.');        
