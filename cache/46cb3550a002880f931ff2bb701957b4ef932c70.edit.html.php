<?php /*%%SmartyHeaderCode:2463457ccc1391a5b90-01385031%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46cb3550a002880f931ff2bb701957b4ef932c70' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\mapel\\edit.html',
      1 => 1514971883,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2463457ccc1391a5b90-01385031',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5a4ca5fb132f35_02259644',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4ca5fb132f35_02259644')) {function content_5a4ca5fb132f35_02259644($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Pelajaran | Tambah Data Pelajaran</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Pelajaran <small>Tambah Data Pelajaran</small>
                </h1>
                <ol class="breadcrumb">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="nama_jurusan" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="subjurusan">Sub Jurusan:</label>
                                            <input type="hidden" value="" name="id_subjurusan" />
                                            <input type="text" value="" class="form-control" name="nama_subjurusan" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kelas">Kelas:</label>
                                            <input type="hidden" value="" name="id_kelas" />
                                            <input type="text" value="" class="form-control" name="nama_kelas" />
                                        </div>
