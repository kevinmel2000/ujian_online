<?php /*%%SmartyHeaderCode:2828957bbc7edb266c1-09068848%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '10bbef8fbdcbc55dc3b24408248c3d1777fb2e34' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\pelaporanpelanggaran\\list.html',
      1 => 1472026515,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2828957bbc7edb266c1-09068848',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57bd585546a370_33015313',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57bd585546a370_33015313')) {function content_57bd585546a370_33015313($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Pelaporan Pelanggaran | List of Pelaporan Pelanggaran</title>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="http://192.168.1.101/pelaporan_pelanggaran/templates/back-end/AdminLTE-2.3.6/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="http://192.168.1.101/pelaporan_pelanggaran/templates/back-end/AdminLTE-2.3.6/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Pelaporan Pelanggaran <small>List of Pelaporan Pelanggaran</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">List of Pelaporan Pelanggaran</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id="form-group">
                                            <table class="table table-striped table-bordered">
                                                <tr>
                                                    ...
                                                    <td width="70%"><label>&nbsp;&nbsp;Kota Depok</label></td>
                                                </tr>                                                
                                            </table>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                                                            <div id='btn_edit' class="btn btn-success disabled">Edit</div>                                                <div id='btn_delete' class="btn btn-danger disabled">Hapus</div>                                                                                    </div>
                                                
                                                                                    <div id="detail" class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th width="5px" rowspan="2"><div style="text-align: center;"><input type="checkbox" id="select_all" /></div></th>
                                                            <th width="5%" rowspan="2"><div style="text-align: center;">No.</div></th>
                                                            <th width="5%" rowspan="2"><div style="text-align: center;">Tahun</div></th>
                                                            <th width="10%" rowspan="2"><div style="text-align: right;">Jumlah Pegawai</div></th>
                                                            ...
                                                            <th width="15%" rowspan="2"><div style="text-align: right;">Jumlah</div></th>
                                                        </tr>
