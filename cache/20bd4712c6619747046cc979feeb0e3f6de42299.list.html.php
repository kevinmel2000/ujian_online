<?php /*%%SmartyHeaderCode:19154578dbfd5adea07-25199865%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '20bd4712c6619747046cc979feeb0e3f6de42299' => 
    array (
  ...
  'nocache_hash' => '19154578dbfd5adea07-25199865',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a04dad1ef622_44041505',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a04dad1ef622_44041505')) {function content_57a04dad1ef622_44041505($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Stock Product <small>List of Stock Product</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/stok">Stock Product</a></li>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_40">
                                            ...
                                            <td align="right">0</td>
                                            <td align="right">0</td>
                                            <td align="right"><input type="text" id="sisa_40" class="form-control harga" value="-18"  style="text-align: right; " /></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="40" class="btn btn-success update">Update</div>
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_41">
                                            <td align="center"><input type="checkbox" id_select="41" name="select_41" class="form-control select" /></td>
                                            ...
                                            <td align="right">0</td>
                                            <td align="right">0</td>
                                            <td align="right"><input type="text" id="sisa_41" class="form-control harga" value="0"  style="text-align: right; " /></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="41" class="btn btn-success update">Update</div>
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_35">
                                            <td align="center"><input type="checkbox" id_select="35" name="select_35" class="form-control select" /></td>
                                            ...
                                            <td align="right">0</td>
                                            <td align="right">0</td>
                                            <td align="right"><input type="text" id="sisa_35" class="form-control harga" value="-9"  style="text-align: right; " /></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="35" class="btn btn-success update">Update</div>
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_34">
                                            <td align="center"><input type="checkbox" id_select="34" name="select_34" class="form-control select" /></td>
                                            ...
                                            <td align="right">0</td>
                                            <td align="right">0</td>
                                            <td align="right"><input type="text" id="sisa_34" class="form-control harga" value="0"  style="text-align: right; " /></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="34" class="btn btn-success update">Update</div>
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_33">
                                            <td align="center"><input type="checkbox" id_select="33" name="select_33" class="form-control select" /></td>
                                            ...
                                            <td align="right">0</td>
                                            <td align="right">0</td>
                                            <td align="right"><input type="text" id="sisa_33" class="form-control harga" value="5"  style="text-align: right; " /></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="33" class="btn btn-success update">Update</div>
                                                </div>
                                            </td>                                          
                                        </tr>
                                        ...
                                        <tr id="baris_32">
                                            <td align="center"><input type="checkbox" id_select="32" name="select_32" class="form-control select" /></td>
                                            ...
                                            <td align="right">0</td>
                                            <td align="right">0</td>
                                            <td align="right"><input type="text" id="sisa_32" class="form-control harga" value="0"  style="text-align: right; " /></td>
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                    <div id_select="32" class="btn btn-success update">Update</div>
                                                </div>
                                            </td>                                          
                                        </tr>
