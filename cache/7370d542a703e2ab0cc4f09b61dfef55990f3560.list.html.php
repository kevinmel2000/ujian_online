...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a2fa1547a4e5_24419947',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a2fa1547a4e5_24419947')) {function content_57a2fa1547a4e5_24419947($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Customer <small>List of Customer</small>
                        </h1>
                        <!-- ol class="breadcrumb">
                          <li><a href="http://192.168.1.101/gomocart">Home</a></li>
                          <li><a href="http://192.168.1.101/gomocart/customer">Customer</a></li>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr id="baris_3">
                                            ...
                                            <td align="left">Kondro Wetan</td>
                                            <td align="left">kondro_wetan@gmail.com</td>
                                            <td align="left">Jalan simatupang jakarta selatan No. 87<br />No. HP: 0812399100</td>
                                            ...
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                <a href="http://192.168.1.101/gomocart/adminweb/customer/detailpesanan.php?id=3" class="btn btn-success">Detail Pesanan</a>
                                            </div></td>
                                        </tr>
                                        ...
                                        <tr id="baris_2">
                                            ...
                                            <td align="left">Membuat Program</td>
                                            <td align="left">membuatprogram@gmail.com</td>
                                            <td align="left">Komplek TNI AD Jln. Kenari VI Blok K 4 No. 5<br />No. HP: 081373011823</td>
                                            <td align="center">Silver</td>
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>                                                                                  
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                <a href="http://192.168.1.101/gomocart/adminweb/customer/detailpesanan.php?id=2" class="btn btn-success">Detail Pesanan</a>
                                            </div></td>
                                        </tr>
                                        ...
                                        <tr id="baris_1">
                                            ...
                                            <td align="center"><span style="font-weight: bold; color: green;">Aktif</span></td>                                                                                  
                                            <td><div style="text-align: center;  white-space: nowrap;">
                                                <a href="http://192.168.1.101/gomocart/adminweb/customer/detailpesanan.php?id=1" class="btn btn-success">Detail Pesanan</a>
                                            </div></td>
                                        </tr>
