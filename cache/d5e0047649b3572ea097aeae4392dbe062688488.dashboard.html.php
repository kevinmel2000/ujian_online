...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '60c2c4593ffc058188626391c362ac7633597f8d' => 
    array (
      0 => 'D:\\www\\ujian_online\\templates\\back-end\\AdminLTE-2.3.6\\includes\\footer_js.html',
      1 => 1473032700,
      2 => 'file',
    ),
  ),
  ...
  'unifunc' => 'content_5a53224bd5a9d0_51296432',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a53224bd5a9d0_51296432')) {function content_5a53224bd5a9d0_51296432($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Aplikasi Sekolah | Halaman Depan</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Rifki Heru A</span>
            </a>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="http://localhost/ujian_online/guru/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="http://localhost/ujian_online/siswa/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="http://localhost/ujian_online/mapel/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
                  ...
                  <div class="small-box bg-aqua">
                    ...
                    <a href="http://localhost/ujian_online/soal/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                        <!-- ./col -->
        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                                ...
                                                <tr id="baris_6">
                                                    ...
                                                    <td align="left">SDN Negeri 486 Jakarta<br /><small>Tingkat , Kelas Satu</small></td>                                                                
                                                    <td align="left">Biologi</td>
                                                    <td align="left">AAGYM<br />Tes Ujian Biologi</td>
                                                    <td align="center">08-01-2018<br />14:30</td>
                                                    <td align="center">
                                                                                                                                                                        <label class="label bg-red">Sedang Berlangsung</label>                                                    </td>                                                                                                       
                                                </tr>
                                                ...
                                                <tr id="baris_4">
                                                    ...
                                                    <td align="left">U001<br />Ujian Kenikan Kelas 2</td>
                                                    <td align="center">19-02-2017<br />13:30</td>
                                                    <td align="center">
                                                        <label class="label bg-green">Sudah Berlalu</label>                                                                                                                                                                    </td>                                                                                                       
                                                </tr>
