...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4cadf0e2b705_18093506',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4cadf0e2b705_18093506')) {function content_5a4cadf0e2b705_18093506($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Kelas | Daftar kelas</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Kelas <small>Daftar kelas</small>
                </h1>
                <ol class="breadcrumb">
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="left">Pendidikan Dasar</td>
                                                                <td align="left">Kelas Satu</td>
                                                                <td align="center">1</td>
                                                                <td align="left">Satu</td>                                                  
                                                                <td align="center"><a href="http://localhost/ujian_online/subkelas/list.php?id_kelas=1" class="btn btn-primary">Sub Kelas</a></td>
                                                            </tr>
                                                            ...
                                                            <tr id="baris_2">
                                                                ...
                                                                <td align="center"><a href="http://localhost/ujian_online/subkelas/list.php?id_kelas=2" class="btn btn-primary">Sub Kelas</a></td>
                                                            </tr>
                                                            ...
                                                            <tr id="baris_3">
                                                                ...
                                                                <td align="left">Satu satu satu</td>                                                  
                                                                <td align="center"><a href="http://localhost/ujian_online/subkelas/list.php?id_kelas=3" class="btn btn-primary">Sub Kelas</a></td>
                                                            </tr>
