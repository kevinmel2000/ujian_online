<?php /*%%SmartyHeaderCode:996957db4c5f7fdd73-42697539%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdc9192f639913e27201ce3b610a72e0b3da9386' => 
    array (
      0 => '..\\templates\\back-end\\AdminLTE-2.3.6\\grupsoal\\edit.html',
      1 => 1473990940,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '996957db4c5f7fdd73-42697539',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57db51356679d0_55210252',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57db51356679d0_55210252')) {function content_57db51356679d0_55210252($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Grup Soal | Tambah Grup Soal Baru</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control"  name="mapel" />
                                            <input type="hidden" value="0" name="id_mapel" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kode_soal">Kode Soal:</label>
                                            <input type="text" value="" class="form-control tanggal" name="kode_soal" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="nilai_benar">Nilai Benar:</label>
                                            <input type="text" value="1" class="form-control" name="nilai_benar" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nilai_salah">Nilai Salah:</label>
                                            <input type="text" value="0" class="form-control" name="nilai_salah" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="perhitungan_score">Perhitungan Score:</label>
                                            <input type="text" value="({nilai_benar}-{nilai_salah})*100" class="form-control" name="perhitungan_score" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="lama_waktu_pengerjaan">Waktu Pengerjaan (Menit):</label>
                                            <input type="text" value="" class="form-control" name="lama_waktu_pengerjaan" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <div id="i_loading" class="G-btn-animation" style="display: none;"><img src="http://192.168.1.102/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/img/loading.gif" /></div>                  
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <link rel="stylesheet" href="http://192.168.1.102/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/js/jquery-ui/jquery-ui-1.10.3.custom.min.css">
    ...
    <link href="http://192.168.1.102/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/js/datepick/jquery.datepick.css" rel="stylesheet">
    <script src="http://192.168.1.102/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/js/datepick/jquery.plugin.js"></script>
    <script src="http://192.168.1.102/ujian_online/templates/back-end/AdminLTE-2.3.6/dist/js/datepick/jquery.datepick.js"></script>
    
    <script type="text/javascript">
        $(function () {           
            var isEdit = false;
            
            $('[name=mapel]').autocomplete({
                source: function( request, response ) {
                    $.ajax({
                        url: 'http://192.168.1.102/ujian_online/store/mapelDataStore.php',
                        dataType: "json",
                        method: 'post',
                        data: {
                            query: request.term
            ...
            $('#btn_simpan').click(function() {
                ...
                data.append('id_mapel', $('[name=id_mapel]').val());
                data.append('mapel', $('[name=mapel]').val());
