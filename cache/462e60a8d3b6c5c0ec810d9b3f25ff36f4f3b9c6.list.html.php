<?php /*%%SmartyHeaderCode:316857a54b0284a6e1-85516621%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '462e60a8d3b6c5c0ec810d9b3f25ff36f4f3b9c6' => 
    array (
      0 => '..\\..\\templates\\back-end\\AdminLTE-2.3.6\\noregistrasi\\list.html',
      1 => 1470557297,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '316857a54b0284a6e1-85516621',
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57a6ec77c666a2_96386126',
  'variables' => 
  array (
    'title' => 0,
    'sub_title' => 0,
...
<?php if ($_valid && !is_callable('content_57a6ec77c666a2_96386126')) {function content_57a6ec77c666a2_96386126($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Nomer Registrasi | List of Nomer Registrasi</title>
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Nomer Registrasi <small>List of Nomer Registrasi</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb">Home</a></li>
                    <li><a href="http://192.168.1.100/sertifikat_online/adminweb/noregistrasi/">Nomer Registrasi</a></li>
                    <li class="active">List of Nomer Registrasi</li>
                </ol>
            </section>
                            ...
                            <div class="box-body">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-3 no-padding">
                                                        <input type="text" value="" class="form-control tanggal" name="tanggal" placeholder="Klik Untuk Memilih Tanggal Ujian..." />
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div id='btn_edit' class="btn btn-success disabled">Lihat</div>                                        </div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="15%"><div style="text-align: center;">Propinsi</div></th>
                                                            <th width="10%"><div style="text-align: center;">Tanggal Ujian</div></th>
                                                            <th width="25%"><div style="text-align: center;">Cabang</div></th>
                                                            <th width="20%"><div style="text-align: center;">Alamat Ujian</div></th>
                                                            <th width="10%"><div style="text-align: center;">Jumlah</div></th>
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr id="baris_1">
                                                                ...
                                                                <td align="center">05-08-2016</td>
                                                                <td align="left"><b>Kota Bogor</b><br />Desa suka maju waluyo Jangkar B. 20 Bogor Jawa barat</td>
                                                                <td align="left">Komp. Veilla asal ajah.</td>
                                                                <td align="center">1</td>                                                                
                                                                <td><div style="text-align: center;  white-space: nowrap;">
                                                                        <div id_select="1" class="btn btn-success edit">Lihat</div>                                                                    </div>
                                                                </td>                                          
                                                            </tr>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#btn_cari" ).click(function() {
                ...
                window.location='list.php?'+(query.length>0?'&query='+query:'')+(tanggal.length>0?'&tanggal='+tanggal:'');
            });
