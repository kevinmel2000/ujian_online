...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a4ae8ee6fd0f9_87734480',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4ae8ee6fd0f9_87734480')) {function content_5a4ae8ee6fd0f9_87734480($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Data Sekolah | Tambah Data Sekolah</title>
      ...
      <ul class="sidebar-menu">
        <li class="header"> MENU </li>
                ...
                <a href="http://localhost/ujian_online/dashboard/"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
                    ...
                    <li class="treeview">
                <a href="http://localhost/ujian_online/pengguna/"><i class="fa fa-user"></i> <span>Admin User</span> </a>
                            </li>
                    <li class="active treeview">
                <a href="http://localhost/ujian_online/sekolah/"><i class="fa fa-edit"></i> <span>Sekolah</span> </a>
                            </li>
                    <li class="treeview">
                <a href="http://localhost/ujian_online/tingkat/"><i class="fa fa-edit"></i> <span>Tingkat</span> </a>
                            </li>
                    <li class="treeview">
    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Data Sekolah <small>Tambah Data Sekolah</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="http://localhost/ujian_online">Home</a></li>
                    <li><a href="http://localhost/ujian_online/sekolah/">Data Sekolah</a></li>
                    <li class="active">Tambah Data Sekolah</li>
                </ol>
            </section>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="A0101" class="form-control" name="kode_sekolah" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="nama_sekolah">Nama Sekolah:</label>
                                            <input type="text" value="SDN Negeri 486 Jakarta" class="form-control" name="nama_sekolah" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="no_badan_hukum">No. Badan Hukum:</label>
                                            <input type="text" value="A10-009-10291-AS1" class="form-control" name="no_badan_hukum" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="tanggal_berdiri">Tanggal Berdiri:</label>
                                            <input type="text" value="15-01-2017" class="form-control tanggal" name="tanggal_berdiri" />
                                        </div>
                                        
                                        
                                        <div class="form-group">
                                            <label for="nss">NSS:</label>
                                            <input type="text" value="130981" class="form-control" name="nss" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="npsn">NPSN:</label>
                                            <input type="text" value="113300998811" class="form-control" name="npsn" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="mbs" class="form-control">
                                                ...
                                                <option value="PAGI DAN SIANG" >PAGI DAN SIANG</option>
                                            </select>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="alamat">Alamat:</label>
                                            <textarea class="form-control" name="alamat" height="80">" " </textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="dusun" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="propinsi" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="kabupaten">Kabupaten:</label>
                                            <input type="text" value="" class="form-control" name="kabupaten" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="kodepos" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="lat">Latitude:</label>
                                            <input type="text" value="0" class="form-control" name="lat" />
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="lng">Longitude:</label>
                                            <input type="text" value="0" class="form-control" name="lng" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" name="kejuruan" />
                                        </div>
